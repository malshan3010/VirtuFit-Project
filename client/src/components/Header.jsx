...
export default function Header() {
  ...
  return (
    <Navbar className="border-b-2 ">
      ...
      >
        <span className="px-2 py-1 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-lg text-white left-10">
          VirtuFit
        </span>
        .LK
      </Link>
      <form onSubmit={handleSearchSubmit} className="flex items-center gap-2 px-4 py-2">
